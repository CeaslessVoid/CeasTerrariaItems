...
{
    public class DuskbladeOfDraktharr : ModItem
    {
        ...
        public static readonly int AdditiveDamageBonus2 = 20;

        public override void UpdateAccessory(Player player, bool hideVisual)
        {
            player.GetDamage(DamageClass.Melee) += AdditiveDamageBonus / 100f;
            player.GetDamage(DamageClass.Ranged) += AdditiveDamageBonus2 / 100f;

            player.GetArmorPenetration(DamageClass.Melee) += 55;
            player.GetArmorPenetration(DamageClass.Ranged) += 55;
        }
    }
}
