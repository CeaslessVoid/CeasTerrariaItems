...
{
    public class RabadonDeathcap : ModItem
    {
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient<Needless>(2);
        ...
        public static readonly int BaseDamageBonus = 10;
        public override void UpdateAccessory(Player player, bool hideVisual)
        {
            ...
            player.GetDamage(DamageClass.Summon).Base += BaseDamageBonus;

            player.GetModPlayer<HieuModPlayer2>().HasRabadon = true;
        }
    }
}
